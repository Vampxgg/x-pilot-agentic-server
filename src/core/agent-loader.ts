...
function loadAgentConfig(folderPath: string): AgentConfig {
  ...
  try {
    ...
    return {
      ...
      graphRecursionLimit: parsed.graphRecursionLimit ?? base.graphRecursionLimit,
      toolLimits: parsed.toolLimits ?? base.toolLimits,
...
function mergeConfigFromWorkflow(
  ...
  return {
    ...
    graphRecursionLimit: workflowConfig.graphRecursionLimit ?? base.graphRecursionLimit,
    toolLimits: workflowConfig.toolLimits ?? base.toolLimits,
